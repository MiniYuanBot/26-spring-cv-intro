...
if __name__ == "__main__":
    ...
    MLP_layer_1 = np.random.randn(784, 16)  # (184, 16)
    ...
    for i in range(50):
        ...
        output_layer_1_act = 1 / (1 + np.exp(-output_layer_1))  # (10, 16)
        output_layer_2 = output_layer_1_act.dot(MLP_layer_2)  # (10, 1)
        # sigmoid activation function
        pred_y = 1 / (1 + np.exp(-output_layer_2))  # (10, 1)
        ...
        grad_output_2 = pred_y - gt_y  # (10, 1)
        grad_layer_2 = output_layer_1_act.T @ grad_output_2  # (16, 1)
        grad_layer_1_act = grad_output_2 @ MLP_layer_2.T  # (10, 16)
        grad_output_1 = grad_layer_1_act * output_layer_1_act * \
            (1 - output_layer_1_act)  # (10, 16)
        grad_layer_1 = input_vector.T @ grad_output_1  # (784, 16)
